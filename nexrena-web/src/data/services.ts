...
export const services: Service[] = [
  {
    ...
    tags: ['Astro', 'Next.js', 'Headless CMS', 'Conversion Systems'],
    ...
    outcomes: [
      { metric: 'Day 30', detail: 'Architecture, conversion map, and implementation plan approved' },
      { metric: 'Day 60', detail: 'Production pages live with analytics and content workflow enabled' },
      { metric: 'Day 90', detail: 'Measured optimization cycle running with clear owner and backlog' }
    ],
    processHook: 'Discovery to first production-ready page in 3 weeks, then scale in weekly sprints.',
    cta: {
      label: 'Request a build review',
      helper: 'Share your current stack, constraints, and goals. If there is a fit, I will map the next 90 days.'
    },
    ...
    problem: {
      ...
      statusQuoTitle: 'What breaks first',
      shiftTitle: 'What changes here',
      statusQuoItems: [
    ...
    features: [
      ...
      { title: 'Performance With Intent', desc: 'Speed work is prioritized around commercial pages so technical gains directly support pipeline outcomes.' }
    ],
  ...
  },
  {
    ...
    cta: {
      ...
      helper: 'If there is a fit, I will map the first 90 days before you publish another page.'
    },
