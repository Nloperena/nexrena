...
Internal operations platform for Nexrena LLC. Manage clients, proposals, projects, invoices, expenses, and website leads — all from one place.
...
Action-oriented daily view:

- **Quick Actions** — links to convert a lead, create proposal, create invoice, or start a project
- **Summary Strip** — pipeline value, collected revenue, outstanding invoices, MTD expenses
- **Needs Attention** — new website leads and proposals awaiting response
- **Active Projects** — projects not yet delivered, with progress bars
- **Outstanding Invoices** — unpaid invoices with amounts and due dates
- **Pipeline** — top 5 active deals from the CRM

For the full operating workflow, see **[WORKFLOW.md](./WORKFLOW.md)**.
...
- **Project Profitability** — revenue, costs, and profit per project
