...
export function ServiceRequestSection({ onCreated }: Props) {
  ...
  return (
    <section>
      <h3 className="text-[10px] uppercase tracking-widest text-slate-500 mb-3">Request service</h3>
      <form onSubmit={submit} className="glass-panel rounded-xl border border-slate-800/60 p-5 space-y-4">
