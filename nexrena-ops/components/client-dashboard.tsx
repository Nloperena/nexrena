...
export function ClientDashboard({ onSignOut }: Props) {
  ...
  const openInvoice = async (id: string) => {
    ...
    try {
      ...
      const inv = await fetchPortalInvoice(id)
    ...
    <div className="max-w-3xl mx-auto flex flex-col gap-8 py-4">
      ...
      <div className={`${card} flex flex-wrap items-start justify-between gap-4`}>
        ...
        <div>
          ...
          <p className="text-[10px] uppercase tracking-widest text-slate-500">Signed in as</p>
          ...
          {editing ? (
            ...
            <>
              ...
              {account?.company && <p className="text-sm text-slate-500">{account.company}</p>}
        ...
        <div className="flex flex-col gap-2">
          ...
          {!editing && <Btn size="sm" variant="ghost" onClick={() => setEditing(true)}>Edit profile</Btn>}
            ...
            <div className="flex justify-between gap-4 items-start">
              ...
              <div>
                ...
                {inv.projectName && (
                  ...
                  <p className="text-sm text-slate-500 mt-0.5">{inv.projectName}</p>
              ...
              <div className="flex flex-col items-end gap-2 shrink-0">
                ...
                <Btn size="sm" variant="ghost" disabled={viewLoading} onClick={() => openInvoice(inv.id)}>
