...
export function AccountSettingsModal({ account, onClose, onUpdated }: Props) {
    ...
    <Modal title="Account settings" onClose={onClose} wide>
      ...
      <form className="space-y-4" onSubmit={saveProfile}>
        ...
        <Field label="Email">
          ...
          <p className="text-[10px] text-slate-600 mt-1.5">Email cannot be changed here. Contact Nexrena if you need to update it.</p>
        </Field>
