...
const STAGE_COLORS: Record<string, string> = {
  ...
  reviewing:   'bg-amber-950/40 text-amber-300 ring-1 ring-amber-800/30',
  quoted:      'bg-purple-950/40 text-purple-300 ring-1 ring-purple-800/30',
  closed:      'bg-slate-800/60 text-slate-500 ring-1 ring-slate-700/30',
